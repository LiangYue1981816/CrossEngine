...
set DEFINES=-DGL_ES -DENABLE_SKINNING -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_SKINNING -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_SKINNING -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_SKINNING -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_LIGHTMAP -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_LIGHTMAP -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_SKINNING -DENABLE_ENVMAP -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_SKINNING -DENABLE_ENVMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_SKINNING -DENABLE_ENVMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_SKINNING -DENABLE_ENVMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_ENVMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_ENVMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_ENVMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SKYLIGHTING -DENABLE_RIMLIGHTING -DENABLE_SPECULARING -DENABLE_NORMALMAP -DENABLE_SPECULARMAP -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_ENVMAP -DENABLE_LIGHTMAP -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_ENVMAP -DENABLE_LIGHTMAP -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_ENVMAP -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_MRT_COLOR_DEPTH
...
set DEFINES=-DGL_ES -DENABLE_OPTIONAL_NORMALIZE -DENABLE_ENVMAP -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_DIFFUSELIGHTING -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_ENVMAP -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_MRT_COLOR_DEPTH
...
@rem set DEFINES=-DGL_ES -DENABLE_ENVMAP -DENABLE_LIGHTMAP -DENABLE_LIGHTING_UNIT0 -DENABLE_LIGHTING_UNIT1 -DENABLE_DIFFUSELIGHTING -DENABLE_SHADOWMAP -DENABLE_SHADOWMAP_PCF -DENABLE_MRT_COLOR_DEPTH
