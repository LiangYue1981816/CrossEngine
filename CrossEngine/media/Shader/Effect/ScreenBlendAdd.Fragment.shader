...
<Parameters>
	...
	<Uniform1f name="blendFactor1" scope="Local" value="0.95"/>
	<Uniform1f name="blendFactor2" scope="Local" value="0.15"/>
</Parameters>
...
UNIFORM_MEDIUMP float blendFactor1;
UNIFORM_MEDIUMP float blendFactor2;
...
void main()
{
	...
	gl_FragColor = blendColor1 * blendFactor1 + blendColor2 * blendFactor2;
}
]]>
</Source>
</Shader>