...
<Parameters>
	...
	<Uniform1i name="ssaomap" scope="Local" value="1"/>
</Parameters>
...
UNIFORM_MEDIUMP sampler2D ssaomap;
UNIFORM_MEDIUMP float ssaoFactor;
...
void main()
{
	...
	MEDIUMP float ssao = texture2D(ssaomap, vTexcoord).r;
	gl_FragColor = vec4(diffuseColor.rgb*ssao, 1.0);
}
]]>
</Source>
</Shader>