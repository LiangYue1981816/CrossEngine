...
#ifndef _json_linkhash_h_
#define _json_linkhash_h_
...
* @return a pointer onto the linkhash table.
*/
extern struct lh_table* lh_kchar_table_new(int size, const char *name, lh_entry_free_fn *free_fn);
...
* @return a pointer onto the linkhash table.
*/
extern struct lh_table* lh_kptr_table_new(int size, const char *name, lh_entry_free_fn *free_fn);
